...
// Redireccionar
 ...
 echo '<meta http-equiv="refresh" content="0; url=http://localhost/2020/Proceso.Editar.Brief.php?PHPKEYID='.$falsekey.'&Id='.$_POST[IdEvento].'&tab=data&tipo='.$_POST[tipo].'">';
...
echo '<meta http-equiv="refresh" content="0; url=http://localhost/2020/Proceso.Editar.Brief.php?PHPKEYID='.$falsekey.'&Id='.$_POST[IdEvento].'&AddTipoDato='.$_POST[tipodato].'&tab=fecha&tipo='.$_POST[tipo].'">';
