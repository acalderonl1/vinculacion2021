...
<tr><td>Modalidad</td>
<td> <?php echo  ExecuteScalar("SELECT `teatro13_temporada`.`esc_modalidades`.`modalidad` FROM `teatro13_temporada`.`esc_modalidades` WHERE `teatro13_temporada`.`esc_modalidades`.`Id` = $filtro"); ?>
</td>
<tr>
<td>MES</td><td></td>
</tr>
...
SELECT
  ...
  `teatro13_temporada`.`esc_alumnos`.`Id` AS `IdAlumno`
FROM
...
WHERE
  ...
  AND
   `teatro13_temporada`.`esc_matriculas`.`estado` = '1'
  ORDER BY
