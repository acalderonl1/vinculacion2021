...
// Create page object
$Live_Brief_Post_add = new Live_Brief_Post_add();

// Run the page
$Live_Brief_Post_add->run();
...
$Live_Brief_Post_add->Page_Render();
?>
...
var fLive_Brief_Postadd = currentForm = new ew.Form("fLive_Brief_Postadd", "add");

// Validate form
fLive_Brief_Postadd.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($Live_Brief_Post_add->tipo->Required) { ?>
		...
		<?php } ?>
		<?php if ($Live_Brief_Post_add->tipoEvento->Required) { ?>
		...
		<?php } ?>
		<?php if ($Live_Brief_Post_add->CategoriaEvento->Required) { ?>
		...
		<?php } ?>
		<?php if ($Live_Brief_Post_add->evento->Required) { ?>
		...
		<?php } ?>
		<?php if ($Live_Brief_Post_add->imagen->Required) { ?>
		...
		<?php } ?>
		<?php if ($Live_Brief_Post_add->__post->Required) { ?>
		...
		<?php } ?>
		<?php if ($Live_Brief_Post_add->fecha->Required) { ?>
		...
		<?php if ($Live_Brief_Post_add->captura->Required) { ?>
		...
		<?php } ?>
		<?php if ($Live_Brief_Post_add->urlIG->Required) { ?>
		...
		<?php } ?>
		<?php if ($Live_Brief_Post_add->urlFB->Required) { ?>
...
fLive_Brief_Postadd.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
fLive_Brief_Postadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fLive_Brief_Postadd.lists["x_tipo"] = <?php echo $Live_Brief_Post_add->tipo->Lookup->toClientList() ?>;
fLive_Brief_Postadd.lists["x_tipo"].options = <?php echo JsonEncode($Live_Brief_Post_add->tipo->options(FALSE, TRUE)) ?>;
fLive_Brief_Postadd.lists["x_tipoEvento"] = <?php echo $Live_Brief_Post_add->tipoEvento->Lookup->toClientList() ?>;
fLive_Brief_Postadd.lists["x_tipoEvento"].options = <?php echo JsonEncode($Live_Brief_Post_add->tipoEvento->options(FALSE, TRUE)) ?>;
fLive_Brief_Postadd.lists["x_CategoriaEvento"] = <?php echo $Live_Brief_Post_add->CategoriaEvento->Lookup->toClientList() ?>;
fLive_Brief_Postadd.lists["x_CategoriaEvento"].options = <?php echo JsonEncode($Live_Brief_Post_add->CategoriaEvento->lookupOptions()) ?>;
fLive_Brief_Postadd.lists["x_evento"] = <?php echo $Live_Brief_Post_add->evento->Lookup->toClientList() ?>;
fLive_Brief_Postadd.lists["x_evento"].options = <?php echo JsonEncode($Live_Brief_Post_add->evento->lookupOptions()) ?>;
...
<?php $Live_Brief_Post_add->showPageHeader(); ?>
<?php
$Live_Brief_Post_add->showMessage();
?>
<form name="fLive_Brief_Postadd" id="fLive_Brief_Postadd" class="<?php echo $Live_Brief_Post_add->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($Live_Brief_Post_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $Live_Brief_Post_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="Live_Brief_Post">
<input type="hidden" name="action" id="action" value="insert">
<input type="hidden" name="modal" value="<?php echo (int)$Live_Brief_Post_add->IsModal ?>">
<div class="ew-add-div"><!-- page* -->
<?php if ($Live_Brief_Post->tipo->Visible) { // tipo ?>
	<div id="r_tipo" class="form-group row">
		<label id="elh_Live_Brief_Post_tipo" for="x_tipo" class="<?php echo $Live_Brief_Post_add->LeftColumnClass ?>"><?php echo $Live_Brief_Post->tipo->caption() ?><?php echo ($Live_Brief_Post->tipo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $Live_Brief_Post_add->RightColumnClass ?>"><div<?php echo $Live_Brief_Post->tipo->cellAttributes() ?>>
...
<?php if ($Live_Brief_Post->tipoEvento->Visible) { // tipoEvento ?>
	<div id="r_tipoEvento" class="form-group row">
		<label id="elh_Live_Brief_Post_tipoEvento" for="x_tipoEvento" class="<?php echo $Live_Brief_Post_add->LeftColumnClass ?>"><?php echo $Live_Brief_Post->tipoEvento->caption() ?><?php echo ($Live_Brief_Post->tipoEvento->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $Live_Brief_Post_add->RightColumnClass ?>"><div<?php echo $Live_Brief_Post->tipoEvento->cellAttributes() ?>>
...
<?php if ($Live_Brief_Post->CategoriaEvento->Visible) { // CategoriaEvento ?>
	<div id="r_CategoriaEvento" class="form-group row">
		<label id="elh_Live_Brief_Post_CategoriaEvento" for="x_CategoriaEvento" class="<?php echo $Live_Brief_Post_add->LeftColumnClass ?>"><?php echo $Live_Brief_Post->CategoriaEvento->caption() ?><?php echo ($Live_Brief_Post->CategoriaEvento->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $Live_Brief_Post_add->RightColumnClass ?>"><div<?php echo $Live_Brief_Post->CategoriaEvento->cellAttributes() ?>>
...
<?php if ($Live_Brief_Post->evento->Visible) { // evento ?>
	<div id="r_evento" class="form-group row">
		<label id="elh_Live_Brief_Post_evento" for="x_evento" class="<?php echo $Live_Brief_Post_add->LeftColumnClass ?>"><?php echo $Live_Brief_Post->evento->caption() ?><?php echo ($Live_Brief_Post->evento->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $Live_Brief_Post_add->RightColumnClass ?>"><div<?php echo $Live_Brief_Post->evento->cellAttributes() ?>>
...
<?php if ($Live_Brief_Post->imagen->Visible) { // imagen ?>
	<div id="r_imagen" class="form-group row">
		<label id="elh_Live_Brief_Post_imagen" class="<?php echo $Live_Brief_Post_add->LeftColumnClass ?>"><?php echo $Live_Brief_Post->imagen->caption() ?><?php echo ($Live_Brief_Post->imagen->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $Live_Brief_Post_add->RightColumnClass ?>"><div<?php echo $Live_Brief_Post->imagen->cellAttributes() ?>>
...
<?php if ($Live_Brief_Post->__post->Visible) { // post ?>
	<div id="r___post" class="form-group row">
		<label id="elh_Live_Brief_Post___post" class="<?php echo $Live_Brief_Post_add->LeftColumnClass ?>"><?php echo $Live_Brief_Post->__post->caption() ?><?php echo ($Live_Brief_Post->__post->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $Live_Brief_Post_add->RightColumnClass ?>"><div<?php echo $Live_Brief_Post->__post->cellAttributes() ?>>
...
<script>
ew.createEditor("fLive_Brief_Postadd", "x___post", 35, 4, <?php echo ($Live_Brief_Post->__post->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
</span>
...
<?php if ($Live_Brief_Post->fecha->Visible) { // fecha ?>
	<div id="r_fecha" class="form-group row">
		<label id="elh_Live_Brief_Post_fecha" for="x_fecha" class="<?php echo $Live_Brief_Post_add->LeftColumnClass ?>"><?php echo $Live_Brief_Post->fecha->caption() ?><?php echo ($Live_Brief_Post->fecha->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $Live_Brief_Post_add->RightColumnClass ?>"><div<?php echo $Live_Brief_Post->fecha->cellAttributes() ?>>
...
<script>
ew.createDateTimePicker("fLive_Brief_Postadd", "x_fecha", {"ignoreReadonly":true,"useCurrent":false,"format":5});
</script>
<?php } ?>
</span>
...
<?php if ($Live_Brief_Post->captura->Visible) { // captura ?>
	<div id="r_captura" class="form-group row">
		<label id="elh_Live_Brief_Post_captura" class="<?php echo $Live_Brief_Post_add->LeftColumnClass ?>"><?php echo $Live_Brief_Post->captura->caption() ?><?php echo ($Live_Brief_Post->captura->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $Live_Brief_Post_add->RightColumnClass ?>"><div<?php echo $Live_Brief_Post->captura->cellAttributes() ?>>
...
<?php if ($Live_Brief_Post->urlIG->Visible) { // urlIG ?>
	<div id="r_urlIG" class="form-group row">
		<label id="elh_Live_Brief_Post_urlIG" for="x_urlIG" class="<?php echo $Live_Brief_Post_add->LeftColumnClass ?>"><?php echo $Live_Brief_Post->urlIG->caption() ?><?php echo ($Live_Brief_Post->urlIG->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $Live_Brief_Post_add->RightColumnClass ?>"><div<?php echo $Live_Brief_Post->urlIG->cellAttributes() ?>>
...
<?php if ($Live_Brief_Post->urlFB->Visible) { // urlFB ?>
	<div id="r_urlFB" class="form-group row">
		<label id="elh_Live_Brief_Post_urlFB" for="x_urlFB" class="<?php echo $Live_Brief_Post_add->LeftColumnClass ?>"><?php echo $Live_Brief_Post->urlFB->caption() ?><?php echo ($Live_Brief_Post->urlFB->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $Live_Brief_Post_add->RightColumnClass ?>"><div<?php echo $Live_Brief_Post->urlFB->cellAttributes() ?>>
...
<?php if (!$Live_Brief_Post_add->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $Live_Brief_Post_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->phrase("AddBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $Live_Brief_Post_add->getReturnUrl() ?>"><?php echo $Language->phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$Live_Brief_Post_add->showPageFooter();
if (DEBUG_ENABLED)
