...
define(PROJECT_NAMESPACE . "PROJECT_NAME", "LiveBrief"); // Project name
define(PROJECT_NAMESPACE . "CONFIG_FILE_FOLDER", PROJECT_NAME); // Config file name
define(PROJECT_NAMESPACE . "RANDOM_KEY", '1AtcZ1iQ1K3MJO6W'); // Random key for encryption
define(PROJECT_NAMESPACE . "ENCRYPTION_KEY", ''); // Encryption key for data protection
define(PROJECT_NAMESPACE . "PROJECT_STYLESHEET_FILENAME", "phpcss/LiveBrief.css"); // Project stylesheet file name
...
$PROJECT_ID = "{E325E099-3A39-45D1-AB29-9A0F13A19286}"; // Project ID (GUID)
$RELATED_PROJECT_ID = "";
...
// Check Token
define(PROJECT_NAMESPACE . "CHECK_TOKEN", FALSE); // Check post token
...
$LANGUAGE_FILE = [];
$LANGUAGE_FILE[] = ["es", "", "spanish.xml"];
define(PROJECT_NAMESPACE . "LANGUAGE_DEFAULT_ID", "es");
...
define(PROJECT_NAMESPACE . "AUDIT_TRAIL_TABLE_NAME", "audittrail"); // Audit trail table name
define(PROJECT_NAMESPACE . "AUDIT_TRAIL_TABLE_VAR", "audittrail"); // Audit trail table var
...
define(PROJECT_NAMESPACE . "ALLOW_LOGIN_BY_SESSION", TRUE); // Allow login by session variables
define(PROJECT_NAMESPACE . "PHPASS_ITERATION_COUNT_LOG2", "[10,8]"); // Note: Use JSON array syntax
define(PROJECT_NAMESPACE . "PASSWORD_HASH", TRUE); // Use PHP 5.5+ password hashing functions
...
define(PROJECT_NAMESPACE . "USER_TABLE_NAME", "usuario");
define(PROJECT_NAMESPACE . "LOGIN_USERNAME_FIELD_NAME", "usuario");
define(PROJECT_NAMESPACE . "LOGIN_PASSWORD_FIELD_NAME", "clave");
...
define(PROJECT_NAMESPACE . "USER_EMAIL_FIELD_NAME", "email");

// User table filters
define(PROJECT_NAMESPACE . "USER_TABLE_DBID", "DB");
define(PROJECT_NAMESPACE . "USER_TABLE", "`usuario`");
define(PROJECT_NAMESPACE . "USER_NAME_FILTER", "(`usuario` = '%u')");
define(PROJECT_NAMESPACE . "USER_ID_FILTER", "");
define(PROJECT_NAMESPACE . "USER_EMAIL_FILTER", "(`email` = '%e')");
...
define(PROJECT_NAMESPACE . "SENDER_EMAIL", "sistema@tcagye.com"); // Sender email address
...
define(PROJECT_NAMESPACE . "UPLOAD_DEST_PATH", "../../data/"); // Upload destination path (relative to app root)
...
define(PROJECT_NAMESPACE . "THUMBNAIL_DEFAULT_WIDTH", 120); // Thumbnail default width
...
define(PROJECT_NAMESPACE . "DELETE_UPLOADED_FILES", TRUE); // Delete uploaded file on deleting record
...
// Audit trail
define(PROJECT_NAMESPACE . "AUDIT_TRAIL_PATH", "_logs/"); // Audit trail path (relative to app root)
