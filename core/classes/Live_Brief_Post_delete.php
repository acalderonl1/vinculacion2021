 ...
 * Page class
 */
class Live_Brief_Post_delete extends Live_Brief_Post
{
	...
	// Page object name
	public $PageObjName = "Live_Brief_Post_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("Live_Brief_Postlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("Live_Brief_Postlist.php"); // Return to list
			}
		}
	}
