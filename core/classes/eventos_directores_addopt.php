 ...
 * Page class
 */
class eventos_directores_addopt extends eventos_directores
{
	...
	// Page object name
	public $PageObjName = "eventos_directores_addopt";
	...
	protected function loadFormValues()
	{
		...
		if (!$this->contacto->IsDetailKey) {
			$this->contacto->setFormValue(ConvertFromUtf8($val));
		}
	...
	public function restoreFormValues()
	{
		...
		$this->contacto->CurrentValue = ConvertToUtf8($this->contacto->FormValue);
