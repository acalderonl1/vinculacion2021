 ...
 * Page class
 */
class eventos_empresarios_addopt extends eventos_empresarios
{
	...
	// Page object name
	public $PageObjName = "eventos_empresarios_addopt";
	...
	protected function loadFormValues()
	{
		...
		if (!$this->empresa->IsDetailKey) {
			$this->empresa->setFormValue(ConvertFromUtf8($val));
		}
		...
		if (!$this->contacto2->IsDetailKey) {
			$this->contacto2->setFormValue(ConvertFromUtf8($val));
		}
		...
		if (!$this->ruc->IsDetailKey) {
			$this->ruc->setFormValue(ConvertFromUtf8($val));
		}
		...
		if (!$this->razonsocial->IsDetailKey) {
			$this->razonsocial->setFormValue(ConvertFromUtf8($val));
		}
	...
	public function restoreFormValues()
	{
		...
		$this->empresa->CurrentValue = ConvertToUtf8($this->empresa->FormValue);
		...
		$this->contacto2->CurrentValue = ConvertToUtf8($this->contacto2->FormValue);
		$this->ruc->CurrentValue = ConvertToUtf8($this->ruc->FormValue);
		$this->direccion->CurrentValue = ConvertToUtf8($this->direccion->FormValue);
		$this->razonsocial->CurrentValue = ConvertToUtf8($this->razonsocial->FormValue);
	}
