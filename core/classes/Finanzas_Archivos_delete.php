 ...
 * Page class
 */
class Finanzas_Archivos_delete extends Finanzas_Archivos
{
	...
	// Page object name
	public $PageObjName = "Finanzas_Archivos_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("Finanzas_Archivoslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("Finanzas_Archivoslist.php"); // Return to list
			}
		}
	}
