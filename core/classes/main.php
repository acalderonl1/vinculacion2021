...
class main
{
	...
	public function __construct()
	{
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'main.php');
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("custom", "main", $url, "", "main", TRUE);
		$this->Heading = $Language->TablePhrase("main", "TblCaption"); 
	}
}
?>