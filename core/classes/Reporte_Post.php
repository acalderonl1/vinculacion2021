...
class Reporte_Post
{
	...
	// Table name
	public $TableName = 'Reporte.Post.php';

	// Page object name
	public $PageObjName = "Reporte_Post";
	...
	public function __construct()
	{
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'Reporte.Post.php');
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("custom", "Reporte_Post", $url, "", "Reporte_Post", TRUE);
		$this->Heading = $Language->TablePhrase("Reporte_Post", "TblCaption"); 
	}
}
?>