 ...
 * Page class
 */
class Live_Brief_Post_view extends Live_Brief_Post
{
	...
	// Page object name
	public $PageObjName = "Live_Brief_Post_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("Id") !== NULL) {
				...
				$returnUrl = "Live_Brief_Postlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "Live_Brief_Postlist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "Live_Brief_Postlist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "") {
