 ...
 * Page class
 */
class Finanzas_Archivos_edit extends Finanzas_Archivos
{
	...
	// Page object name
	public $PageObjName = "Finanzas_Archivos_edit";
	...
	protected function loadFormValues()
	{
		...
		// Check field name 'archivo' first before field var 'x_archivo'
		$val = $CurrentForm->hasValue("archivo") ? $CurrentForm->getValue("archivo") : $CurrentForm->getValue("x_archivo");
		if (!$this->archivo->IsDetailKey) {
			if (IsApi() && $val == NULL)
				$this->archivo->Visible = FALSE; // Disable update for API request
			else
				$this->archivo->setFormValue($val);
		}
	...
	public function loadRowValues($rs = NULL)
	{
		...
		$this->archivo->setDbValue($row['archivo']);
	...
	public function renderRow()
	{
		...
		if ($this->RowType == ROWTYPE_VIEW) { // View row
			...
			if (REMOVE_XSS)
				$this->archivo->CurrentValue = HtmlDecode($this->archivo->CurrentValue);
			$this->archivo->EditValue = HtmlEncode($this->archivo->CurrentValue);
	...
	protected function validateForm()
	{
		...
		if ($this->archivo->Required) {
			if (!$this->archivo->IsDetailKey && $this->archivo->FormValue != NULL && $this->archivo->FormValue == "") {
