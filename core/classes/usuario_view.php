 ...
 * Page class
 */
class usuario_view extends usuario
{
	...
	// Page object name
	public $PageObjName = "usuario_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "usuariolist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "usuariolist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "usuariolist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "") {
