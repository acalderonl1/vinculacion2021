...
/**
 * Table class for eventos_directores
 */
class eventos_directores extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'eventos_directores';
		$this->TableName = 'eventos_directores';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`eventos_directores`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new DbField('eventos_directores', 'eventos_directores', 'x_id', 'id', '`id`', '`id`', 19, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// nombres
		$this->nombres = new DbField('eventos_directores', 'eventos_directores', 'x_nombres', 'nombres', '`nombres`', '`nombres`', 200, -1, FALSE, '`nombres`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nombres->Required = TRUE; // Required field
		$this->nombres->Sortable = TRUE; // Allow sort
		$this->fields['nombres'] = &$this->nombres;

		// apellidos
		$this->apellidos = new DbField('eventos_directores', 'eventos_directores', 'x_apellidos', 'apellidos', '`apellidos`', '`apellidos`', 200, -1, FALSE, '`apellidos`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->apellidos->Required = TRUE; // Required field
		$this->apellidos->Sortable = TRUE; // Allow sort
		$this->fields['apellidos'] = &$this->apellidos;

		// contacto
		$this->contacto = new DbField('eventos_directores', 'eventos_directores', 'x_contacto', 'contacto', '`contacto`', '`contacto`', 200, -1, FALSE, '`contacto`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->contacto->Required = TRUE; // Required field
		$this->contacto->Sortable = TRUE; // Allow sort
		$this->fields['contacto'] = &$this->contacto;

		// email
		$this->_email = new DbField('eventos_directores', 'eventos_directores', 'x__email', 'email', '`email`', '`email`', 200, -1, FALSE, '`email`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom <> "") ? $this->SqlFrom : "`eventos_directores`";
	}
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "eventos_directoreslist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "eventos_directoresview.php")
			return $Language->phrase("View");
		elseif ($pageName == "eventos_directoresedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "eventos_directoresadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("eventos_directoresview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("eventos_directoresview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "eventos_directoresadd.php?" . $this->getUrlParm($parm);
		else
			$url = "eventos_directoresadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("eventos_directoresedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("eventos_directoresadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("eventos_directoresdelete.php", $this->getUrlParm());
	}
