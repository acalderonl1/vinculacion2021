 ...
 * Page class
 */
class Finanzas_Archivos_view extends Finanzas_Archivos
{
	...
	// Page object name
	public $PageObjName = "Finanzas_Archivos_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("Id") !== NULL) {
				...
				$returnUrl = "Finanzas_Archivoslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "Finanzas_Archivoslist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "Finanzas_Archivoslist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "") {
