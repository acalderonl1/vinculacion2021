...
<link rel="stylesheet" type="text/css" href="<?php echo $RELATIVE_PATH ?>timepicker/jquery.timepicker.css">
<script src="<?php echo $RELATIVE_PATH ?>timepicker/jquery.timepicker.min.js"></script>
<script src="<?php echo $RELATIVE_PATH ?>phpjs/ewtimepicker.js"></script>
...
<div class="wrapper ew-layout">
	...
	<aside class="<?php echo $SIDEBAR_CLASS ?>">
		...
		<a href="#" class="brand-link bg-gray-light">
			<img src="<?php echo $RELATIVE_PATH ?>phpimages/logoeventos.png" alt="" class="brand-image ew-brand-image">
		</a>
		<!-- Sidebar -->
		<div class="sidebar">
			<!-- Sidebar Menu -->
