...
<meta http-equiv="refresh" content="1; url=http://localhost/2020/main.php?m=<?php echo $fecha[1];?>&y=<?php echo $fecha[0];?>">
...
<table class="table table-bordered">
<tr><td>
<a href="http://localhost/2020/main.php" class="btn btn-default"><i class="fa fa-calendar" aria-hidden="true" style="font-size: 60px;"></i><br>Regresar a la Agenda</a>
</td>
<td>
<a href="http://localhost/2020/Proceso.Imprimir.Brief.php?Id=<?php echo $_GET[Id];?>" target="_blank" class="btn btn-default"><i style="font-size: 60px;" class="fa fa-print" aria-hidden="true"></i><br>Imprimir / Ver Brief</a>
</td>
</tr></table>
...
//TRABAJAMOS LOS DATOS
 ...
 // Redireccionar
   ...
   echo '<meta http-equiv="refresh" content="0; url=http://localhost/2020/Proceso.Agregar.Brief.php?tipo='.$_POST[tipo].'&retorno='.$_POST[retorno].'&paso=2GLOBAL&cod='.$_POST[cod].'">';
...
// Redireccionar
   ...
   echo '<meta http-equiv="refresh" content="0; url=http://localhost/2020/Proceso.Agregar.Brief.php?tipo='.$_POST[retorna].'&paso=3GLOBAL&cod='.$_POST[cod].'&Id='.$_POST[Id].'">';
